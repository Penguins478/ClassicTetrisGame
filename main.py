...
class Tetris():
    ...
    def new_game(self):
        ...
        self.deque = collections.deque(Shape() for _ in range(4))
        # print(self.deque)
        self.update_piece()
    ...
    def update_piece(self):
        ...
        self.next_canvas.delete("all")
        self.__draw_next_canvas_frame()
        self.next_piece = Piece(self.next_canvas, (20, 20), self.deque.popleft())
        self.deque.append(Shape())
        for i, sh in enumerate(self.deque):
            Piece(self.next_canvas, (20, 120 + (i * 100)), sh)
        self.update_predict()
    ...
    def __draw_next_canvas_frame(self):
        self.next_canvas.create_rectangle(10, 10, 100, 100, tags="frame")
